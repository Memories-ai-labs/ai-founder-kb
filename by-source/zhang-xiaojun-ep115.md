# Source: Zhang Xiaojun EP115

**Entries**: 4

---

## Yao Shunyu (OpenAI) — 2025-09

**★★★** [Strategy]: In the second half of the agent era the bottleneck shifts: from "method" to "how do you define a good task and good environment."
...
**★★★** [Strategy]: "Language is a tool humans invented to achieve generalization — it's more fundamental than anything else."
...
**★★★** [Strategy]: The future of intelligence isn't unipolar — it will be defined collectively by multiple Super Apps.
...
**★★★** [Product]: The biggest opportunity for startups = designing a different interface. As model capability rises, it will eventually spawn a Super App beyond ChatGPT.
